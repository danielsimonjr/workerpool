(module
 ...
 (func $src/ts/assembly/ring-buffer/push@varargs (param $0 i32) (param $1 i32) (result i32)
  ...
  block $__inlined_func$src/ts/assembly/ring-buffer/push (result i32)
   i32.const 0
   call $src/ts/assembly/memory/validateMemory
   i32.eqz
   br_if $__inlined_func$src/ts/assembly/ring-buffer/push
   drop
   i32.const 24
   i64.atomic.load32_u
   local.set $2
 ...
 (func $src/ts/assembly/priority-queue/getHeapEntryAddr (param $0 i32) (result i32)
 ...
 (func $src/ts/assembly/errors/isSuccess (param $0 i64) (result i32)
  local.get $0
  call $src/ts/assembly/ring-buffer/unpackPriority
  i32.eqz
 )
 ...
 (func $src/ts/assembly/atomics/acquireLock@varargs (param $0 i32) (param $1 i32) (result i32)
  ...
  block $__inlined_func$src/ts/assembly/atomics/acquireLock$8 (result i32)
   loop $for-loop|0
    local.get $1
    local.get $2
    i32.gt_u
    if
     ...
     br_if $__inlined_func$src/ts/assembly/atomics/acquireLock$8
     drop
     local.get $2
     i32.const 1
     i32.add
 ...
 (func $~lib/staticarray/StaticArray<f64>#get:length (result i32)
  i32.const 1052
  i32.load
  i32.const 3
  i32.shr_u
 ...
 (func $src/ts/assembly/histogram/recordValue (param $0 f64)
  ...
  i32.atomic.load
  local.set $2
  block $__inlined_func$src/ts/assembly/histogram/findBucket$10
   loop $for-loop|0
    local.get $1
    local.get $2
    i32.lt_u
    if
     ...
     local.get $0
     f64.ge
     br_if $__inlined_func$src/ts/assembly/histogram/findBucket$10
     local.get $1
     i32.const 1
     i32.add
     local.set $1
